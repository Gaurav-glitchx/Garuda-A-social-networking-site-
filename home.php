  ...
  <div  class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>This is Garuda the messenger is developed by <span style="font-weight: 700;">BCA(Islamia)</span>  for learning purpose.</p>
        <p>This project includes tweet , retweet , quote or even quote the quoted tweet , like tweet and nested comments.
        ...
        <p>By default you followed
          <a style="color:#207ce5;" href="codeastro">@bca_islamia</a> 
    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <img src="<?php echo BASE_URL . "/assets/images/twitter-logo.png"; ?>" alt="" height="70px" width="70px" />
            </div>
          </div>
          ...
          <a href="home.php"><button class="button-twittear">
            <strong>Tweet</strong>
          </button></a>
      ...
      <div class="grid-posts">
        ...
        <div class="wrapper-right">
          ...
          <input type="text" class="form-control search-input"  placeholder="Search Garuda">
