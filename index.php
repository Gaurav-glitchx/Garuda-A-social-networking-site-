...
<main class="twt-main">
            ...
            <?php include 'includes/login.php';  ?>
                    ...
                    <img class="login-bird" src="<?php echo BASE_URL . "/assets/images/twitter-logo.png"; ?>" alt="bird">
                        ...
                        <span class="front-para">See what’s happening in the world right now and Share your views.</span>
                        <span class="join">Join Garuda Today.</span>
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <footer>
                <ul>
                    ...
                    <li>© 2023 - Garuda</li>
                    <li style="color:#ff5733;"><b><a href="team/index.html">- Developed By BCA(Islamia) -</a></b></li>
                </ul>
            </footer>
        </main>
