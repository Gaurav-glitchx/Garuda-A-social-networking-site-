...
<?php  if (isset($_SESSION['errors_signup'] )) { ?>
        ...
        $("#exampleModalCenter").modal('show');
                ...
                &nbsp;&nbsp;<input type="radio" name="gender" value="male"  id="exampleInputEmail1" aria-describedby="emailHelp">Male&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <input type="radio" name="gender" value="female" id="exampleInputEmail1" aria-describedby="emailHelp">Female&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <input type="radio" name="gender" value="other" id="exampleInputEmail1" aria-describedby="emailHelp">Other
               </div>
                <div class="form-group">
